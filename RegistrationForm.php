...
$db=mysqli_select_db ($conn, "weddinghall");
if(!$db)
{
                ...
                <div class="bodi">
                    <form action=" " method="POST">
                        <div class="in">
                            ...
                            <input type="text" class="init" name="Name"/>
                        </div>
                        <div class="in">
                            <br>
                            <label for="Email">Email Address </label><br>
                            <input type="text" class="init" name="Email"/><br>
                        </div>
                        <div class="in">
                            <br>
                            <label for="CNIC">CNIC Number</label><br>
                            <input type="text" class="init" name="CNIC"/>
                        </div>
                        <div class="in">
                            <br>
                            <label for="Password">Password:</label><br>
                            <input type="Password" class="init" name="Password"/>
                        </div>
                        <div class="in">
                            <label for="contactNo" >Contact Number </label><br>
                            <input type="text" class="init" name="contactNo"/>
                        </div>
                        <div>
