                ...
                <div class="bodi">
                    <form action=" " method="POST">
                        ...
                        <div class="in">
                            ...
                            <input type="text" class="init" name="clientNo"/><br>
                        </div>
                        <div class="in">
                            <br>
                            <label for="dateOfEvent">Select the date for which you want to book this hall:</label><br>
                            <input type="date" class="init" name="dateOfEvent"/>
                        </div>
                        <div class="in">
                            <label for="time">Enter the time of Event:</label><br>
                            <input type="time" class="init" name="time"/>
                        </div>
                        <div class="in">
                            <label for="payment">Select Payment Method </label><br><br>
                            Cash<input type="checkbox" class="init" name="payment" id="abc" onclick="checkMe()"/>
